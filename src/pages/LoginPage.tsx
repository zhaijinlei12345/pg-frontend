  ...
  return (
    ...
    >
      ...
      >
        ...
        <Title
          level={1}
          style={{ color: '#f1f5f9', marginBottom: 8, fontSize: 36, fontWeight: 800, letterSpacing: -1 }}
        >
          {t('app.title')}
        </Title>
        ...
        >
          ...
          <div style={{ padding: '24px 28px 32px' }}>
            <Form form={form} onFinish={tab === 'login' ? handleLogin : handleRegister} layout="vertical" size="large">
              ...
              <Form.Item name="password" rules={[{ required: true }, ...(tab === 'register' ? [{ min: 6 }] : [])]}>
                <Input.Password
                  prefix={<LockOutlined />}
                  placeholder={tab === 'login' ? t('auth.password') : t('auth.passwordPlaceholder')}
                />
              </Form.Item>
              {tab === 'register' && (
                <Form.Item
